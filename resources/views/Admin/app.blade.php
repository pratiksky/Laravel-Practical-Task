        ...
        <div class="col-md-12">
            <div id="loading" style="display: none;">
                <div style="position: fixed;z-index: 9999; left: 40%;top: 37% ;width: 100%">
                    <img width="200" src="{{asset('assets/back-end/img/loader.gif')}}">
                </div>
            </div>
        </div>
    </div>
...
{{--<div class="modal fade" id="popup-modal1">
                    ...
                    <div class="col-12">
                        <center>
                            <h2 style="color: rgba(96,96,96,0.68)">
                                <i class="tio-shopping-cart-outlined"></i> {{('You have new turf booking, Check Please.')}}
                            </h2>
                            <hr>
