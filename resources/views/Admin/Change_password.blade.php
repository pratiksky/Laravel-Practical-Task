...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-end">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="{{route('panel.dashboard')}}">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="{{route('panel.Update-Profile')}}" method="post" enctype="multipart/form-data" id="admin-profile-form">
                @csrf
